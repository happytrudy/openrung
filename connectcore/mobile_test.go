...
func TestMobileIdentityTelemetryOwnershipAndRestart(t *testing.T) {
	...
	for _, e := range received {
		...
		if e.Attributes["engine"] != "connectcore" || e.Attributes["engine_version"] != "0.6.0" || e.Attributes["platform"] != "android" || e.Attributes["app_version"] != "0.3.9" || e.Attributes["device_model"] != "test" {
